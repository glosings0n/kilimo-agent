import { Mic, Eye, CheckCircle2, MapPin, Scale } from 'lucide-react';
...
export default function MultimodalInsights({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="bg-[#0F172A]/90 border border-slate-800/90 rounded-3xl p-5 sm:p-6  space-y-4 relative overflow-hidden">
        <div className="flex items-center justify-between border-b border-slate-800 pb-3">
          ...
          <span className="text-[10px] font-mono uppercase px-2.5 py-0.5 rounded-full bg-amber-500/10 text-amber-300 border border-amber-500/30 font-bold">
            Ground Truth
          </span>
        </div>
        ...
        <div className="text-[11px] text-slate-400 flex items-center gap-1.5 pt-1 font-medium">
          ...
          <span>{t.detectedDialect} <strong className="text-white">{audioData.dialect || 'Swahili'}</strong></span>
        </div>
      </div>
