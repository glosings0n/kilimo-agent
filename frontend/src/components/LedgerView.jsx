...
export default function LedgerView({
  ...
  return (
    <div className="bg-[#0F172A]/90 border border-slate-800/90 rounded-3xl p-5 sm:p-6  space-y-5">
      {/* Header */}
      ...
      {/* Raw Output Block */}
      <div className="rounded-2xl bg-[#0B0F17] border border-slate-800 p-4 font-mono text-xs leading-relaxed text-slate-300 overflow-x-auto max-h-96 custom-scrollbar shadow-xs">
